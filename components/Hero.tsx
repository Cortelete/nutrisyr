...
const Hero: React.FC<HeroProps> = ({ onBioClick, onScheduleClick }) => {
  return (
    <div className="text-center">
      ...
      <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-rose-400 animated-gradient-text">
        Syrlean Biedermann
      </h1>
      <p className="mt-2 text-sm sm:text-base font-semibold tracking-widest uppercase bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-rose-400 animated-gradient-text">
        Nutrição Esportiva
      </p>
